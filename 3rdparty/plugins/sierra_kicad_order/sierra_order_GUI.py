...
class matrixDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.m_qty1Text = wx.StaticText( self, wx.ID_ANY, u"3", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL )
		...
		self.m_qty2Text = wx.StaticText( self, wx.ID_ANY, u"6", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL )
		...
		self.m_qty3Text = wx.StaticText( self, wx.ID_ANY, u"9", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL )
		...
		self.m_qty4Text = wx.StaticText( self, wx.ID_ANY, u"12", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_CENTER_HORIZONTAL )
